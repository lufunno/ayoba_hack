...
if(isset($IncidentId)){
	{$rs2=mysqli_query("select * from incidentreport where IncidentId='$IncidentId'");
	mysqli_query("update incidentreport set seen=1 where IncidentId='$IncidentId'");
	}
$row2= mysqli_fetch_array($rs2, MYSQLIi_ASSOC);
}
